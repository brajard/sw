...
class SWparnn(SWmodel):
	def __init__ (self, nnupar,nnvpar,nout=(1,1),delta=(1,1),
			f0=3.5e-5, beta=2.11e-11, gamma=2e-7, gstar=0.02,
...
class SWparnnim(SWmodel):
	def __init__ (self, nnupar='',nnvpar='', f0=3.5e-5, beta=2.11e-11, gamma=2e-7, gstar=0.02, rho0=1000, H=500,
			fwind=None, warg={ }, nu=0.72, dt=1800, dx=20e3, dy=20e3, alpha=0.025, nx=80, ny=80 ):
		SWmodel.__init__(self,f0, beta, gamma, gstar,rho0, H, fwind, warg, nu, dt,
			dx, dy, alpha, nx, ny )
...
class SWparnnhdyn(SWmodel):
	def __init__ (self, nnupar='',nnvpar='',nnhdyn='', f0=3.5e-5, beta=2.11e-11, gamma=2e-7, gstar=0.02, rho0=1000,
			H=500, fwind=None, warg={ }, nu=0.72, dt=1800, dx=20e3, dy=20e3, alpha=0.025, nx=80, ny=80 ):
		SWmodel.__init__(self,f0, beta, gamma, gstar,rho0, H, fwind, warg, nu, dt,
			dx, dy, alpha, nx, ny )
